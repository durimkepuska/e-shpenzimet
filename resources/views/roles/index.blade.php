  ...
  <table id="myTable" class="tablesorter table table-hover ">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="{!! action('RoleController@show', [$datas->id]) !!}">{!! $datas->role !!}</a></td>
        <td>
          <div class="btn-group">
            ...
            <ul class="dropdown-menu" role="menu">
              ...
              <li><a href="{!! url('roles/'.$datas->id.'/edit' ) !!}">Edit</a></li>

              <li>
                <a>
                 {!! Form::open(['method' => 'DELETE', 'url' => 'roles/'.$datas->id, 'id'=>'myForm']) !!}
