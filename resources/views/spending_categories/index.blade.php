...
@include('spending_categories.buttons')
  <table id="myTable" class="tablesorter table table-hover ">
    ...
    <tbody>
      ...
      <tr>
        <td>{!! $datas->id !!}</td>
        <td><a href="{!! action('SpendingCategoryController@show', [$datas->id]) !!}">{!! $datas->spending_category !!}</a></td>
        <td>
          <div class="btn-group">
            ...
            <ul class="dropdown-menu" role="menu">
              ...
              <li><a href="{!! url('spending_categories/'.$datas->id.'/edit' ) !!}">Edit</a></li>

              <li>
                <a>
                 {!! Form::open(['method' => 'DELETE', 'url' => 'spending_categories/'.$datas->id, 'id'=>'myForm']) !!}
    ...
    @include('spending_categories.results')
</table>
 {!! $data->render() !!}
