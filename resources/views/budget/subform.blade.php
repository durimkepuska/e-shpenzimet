<div class="modal fade" id="addbudget{!!$datas->id!!}" role="dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title " style="text-align:left;" >
            ...
            Shkruani vlerën e buxhetit që do të shtoni për kategorinë:<br>{!!$datas->spendingtype->spendingtype!!}
        </h4>
      </div>
      <div class="modal-body">
        {!! Form::open(['method'=>'POST','action' => 'BudgetController@addbudget']) !!}
        {!! csrf_field() !!}
